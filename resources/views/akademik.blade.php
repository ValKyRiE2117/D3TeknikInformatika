    ...
    <section class="">
        <div class="pb-8 px-4 mx-auto max-w-screen-xl  lg:px-6">
            <div class=" bg-primary-600 p-8 rounded-lg">
                <h2 class="mb-8 text-xl lg:text-2xl font-extrabold text-white text-center">
                   Sistem Monitoring Mahasiswa
                </h2>
                <div class="flex justify-center items-center"> <!-- Added this div -->
                    <a href="/sistem-monitoring-mahasiswa" class="inline-flex items-center justify-center text-primary-700 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-md px-7 py-3 text-center lg:inline-flex lg:w-auto w-full mb-2 lg:mb-0 transition mx-0">
                        Log in
