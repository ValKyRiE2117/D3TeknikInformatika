    ...
    <div class="p-4 sm:ml-72 bg-gray-100 min-h-screen">
        <nav class="flex mt-16 mb-4" aria-label="Breadcrumb">
            ...
            <li class="inline-flex items-center">
                <a  class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600 ">
        ...
        <div class="p-4 bg-white rounded-lg shadow flex justify-between items-start lg:items-center flex-nowrap flex-col lg:flex-row"> 
            <h2 class="text-xl lg:text-2xl tracking-tight font-extrabold text-gray-700">Daftar Nilai Mahasiswa</h2>
            {{-- <div class="gap-2">
                <a href="#" class="inline-flex items-center text-white bg-acorange-500 hover:bg-acorange-600 border-2 border-acorange-500 hover:border-acorange-600 focus:ring-4 focus:ring-acorange-300 font-medium rounded-lg text-sm px-5 py-2 text-center transition">
                    Input Nilai Mahasiswa
                   
                </a>
                <a href="#" class="inline-flex items-center text-acorange-600 hover:text-white bg-white hover:bg-acorange-500 border-2 border-acorange-500 focus:ring-4 focus:ring-acorange-300 font-medium rounded-lg text-sm px-5 py-2 text-center transition">
            ...
            <table id="search-table" class="min-w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            <span class="flex items-center">Nama Mahasiswa
                                <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4"/>
                                </svg>
                            </span>
                        ...
                        <th>
                            <span class="flex items-center">Nim Mahasiswa
                                <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4"/>
                                </svg>
                            </span>
                        ...
                        <th>
                            <span class="flex items-center">Matakuliah
                                <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4"/>
                                </svg>
                            </span>
                        ...
                        <th>
                            <span class="flex items-center">Nilai Akhir
                                <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4"/>
                                </svg>
                            </span>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-medium text-gray-900 whitespace-nowrap">{{ $item->mahasiswa->nama_mhs ?? 'Unknown' }}</td>
                        <td class="font-medium whitespace-nowrap">{{ $item->mahasiswa->nim ?? 'Unknown' }}</td>
                        <td  class="font-medium whitespace-nowrap">{{ $item->matakuliah->nama_matkul ?? 'Unknown' }}</td>
                        <td class="font-bold text-gray-900 whitespace-nowrap">{{ $item->nilai_akhir }}</td>
                        <td class="flex items-center px-6 py-4 gap-1 text-center">
                            ...
                            <a href="#" class="text-white bg-acred-500 hover:bg-acred-600 focus:ring-4 focus:ring-acred-200 font-medium rounded-lg text-sm px-4 py-2 focus:outline-none">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
