    ...
    <div class="p-4 sm:ml-72 bg-gray-100 min-h-screen">
        <nav class="flex mt-16 mb-4" aria-label="Breadcrumb">
            ...
            <li class="inline-flex items-center">
                <a href="/sistem-monitoring-mahasiswa/tahunajar/" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600 ">
            ...
            <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Tambah Mahasiswa</a>
                </div>
            </li>
            </ol>
        </nav>
        ...
        <div class="p-4 bg-white rounded-lg shadow flex justify-between items-start lg:items-center flex-nowrap flex-col lg:flex-row"> 
            <h2 class="text-xl lg:text-2xl tracking-tight font-extrabold text-gray-700">Tambah Tahun Ajaran</h2>
        </div>
        ...
        <div class="p-4 bg-white rounded-lg shadow flex justify-between items-start lg:items-center flex-nowrap flex-col lg:flex-row my-4">
            <form class="w-full" method="POST" action="{{ route('tahunajar.store') }}">
                @csrf
                <div class="grid gap-2 md:gap-4 grid-cols-1 lg:grid-cols-12 mb-3">
                    <div class="col-span-6 lg:col-span-2">
                        <label for="tahun_mulai" class="block mb-2 text-md font-medium text-gray-900">Tahun Mulai</label>
                        <input type="number" name="tahun_mulai" id="tahun_mulai" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" data-input-counter data-input-counter-min="2000" data-input-counter-max="3000" required value="2024"/>
                    </div>
                    <div class="col-span-6 lg:col-span-2">
                        <label for="tahun_selesai" class="block mb-2 text-md font-medium text-gray-900">Tahun Selesai</label>
                        <input type="number" name="tahun_selesai" id="tahun_selesai" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" data-input-counter data-input-counter-min="2000" data-input-counter-max="3000" required value="2025"/>
                    </div>
                    <div class="col-span-12 lg:col-span-2">
                        <label for="semester" class="block mb-2 text-md font-medium text-gray-900">Semester</label>
                        <select id="semester" name="semester" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="" required>
                            <option value="ganjil">Ganjil</option>
                            <option value="genap">Genap</option>
                        </select>
                    </div>
                    <div class="col-span-12 lg:col-span-3">
                        <label for="deskripsi" class="block mb-2 text-md font-medium text-gray-900">Deskripsi</label>
                        <input type="text" name="deskripsi" id="deskripsi" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="2024/2025 Ganjil" required />
                    </div>
                    <div class="col-span-12 lg:col-span-3">
                        <label for="status" class="block mb-2 text-md font-medium text-gray-900">Status</label>
                        <select id="status" name="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="" required>
